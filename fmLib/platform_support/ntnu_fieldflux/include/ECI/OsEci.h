...
///////////////////////////////////////////////////////////////////////////////
/**
  Suspends the current thread for the specifed time.

  @param dwMicroseconds
    Number of microsends [us] to suspend thread
...
///////////////////////////////////////////////////////////////////////////////
/**
  Creates a new unamed event. The event is initially not signaled and auto
  reset.
...
/**
  ...
  @param dwTimeout
    ...
    elapses, the function returns, even if the object's state is nonsignaled.
...
///////////////////////////////////////////////////////////////////////////////
/**
  Creates a new unamed mutex which can be uses for mutual exclusion
