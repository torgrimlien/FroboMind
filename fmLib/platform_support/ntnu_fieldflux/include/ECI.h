...
/**
  ...
  @note
    ...
    * If function returns successful you can immediately call this
      function again.
...
/**
  ...
  @note
    ...
    * If function returns successful immediately call this function again.
...
///////////////////////////////////////////////////////////////////////////////
/**
  Function to configure message filtering.
...
*/
ECI_DLLEXPORT
ECI_RESULT ECI_APICALL ECIDRV_CtrlSetFilter ( const ECI_CTRL_HDL     hCtrl,
...
/**
  ...
  @note An ECI error string can only be retrieved after a successfull call of
