...
typedef enum
{
  ...
  ECI_ERR_INVALID_DATATYPE,                      ///< The datatype is invalid.
  ...
  ECI_ERR_FWDOWNLOAD,                             ///< An error occured while downloading or verifying firmware
  ECI_ERR_DPRAM_LOCK_VIOLATION,                   ///< A lock violation occured while communication via DPRAM interface.
  ECI_ERR_DRPAM_IO_ERROR,                         ///< An I/O error occured while reading from or writing to DRPAM interface
  ECI_ERR_UNSUPPORTED_FWVERSION,                  ///< The bootmanager or firmware version is unsupported.
